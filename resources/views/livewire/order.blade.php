                            ...
                            <div class="left">
                                <div class="coupon">
                                    <div class="form-row row justify-content-center">
                                        ...
                                        <div class="form-group col-lg-6">
                                            @if ($discount)
                                                <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">{{$discount->value}} %</span>
                                                </td>
                                            @endif
                                        </div>
                                    </div>
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="mb-3">
                    <div class="cart-action text-end">
                        <a href="{{route('address.create')}}" class="btn"><i class="fi-rs-shopping-bag mr-10"></i> اضافة
                            عنوان توصيل اخر</a>
                    </div>
                    <br>
