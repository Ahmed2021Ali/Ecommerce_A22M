    ...
    <div class="mobile-header-wrapper-inner">
        ...
        @if(Auth::check())
            ...
            <div class="single-mobile-header-info"
                 style="margin-left: auto; display: flex; align-items: center; justify-content: center;">
                <a href="{{ route('profile.index') }}" style="text-decoration: none; color: black; text-align: center;">
                    @if (Auth::user()->hasMedia('userImages'))
                        <div style="display: flex; flex-direction: column; align-items: center; margin-right: 5px;">
                            <img src="{{ Auth::user()->getFirstMediaUrl('userImages') }}" alt="User Image" style="width: 108px; height: 107px; border-radius: 50%; margin-bottom: 5px; margin-top: 15px;">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-search search-style-3 mobile-header-border" style="direction: rtl; text-align: right;">
                <form action="{{ route('search') }}" method="GET">
                    <input type="text" placeholder="بحث" name="search" style="direction: rtl; text-align: right;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="widget-about font-md mb-md-5 mb-lg-0">
                    ...
                    <div class="mobile-social-icon">
                        <a href="https://www.facebook.com/profile.php?id=100095016672467&mibextid=ZbWKwL"><i
