                        ...
                        <div class="product-detail accordion-detail">
                            <div class="row mb-50">
                                    ...
                                    <div class="detail-info" style="direction: rtl; text-align: right;">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                ...
                                                <ins><span
                                                        class="old-price font-md ml-15">{{$product->price_after_offer}}</span>
                                                </ins>
                                                <span
                                        ...
                                        <form action="{{route('cart.store',$product)}}" method="post">
                                            ...
                                            <div class="attr-detail attr-color mb-15">
                                                ...
                                                <ul class="list-filter color-filter select-list">
                                                    @foreach (explode(',', $product->color) as $color)
                                                        <li><a href="#" data-color="{{$color}}"><span
                                                                    class="product-color-{{$color}}"></span></a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                ...
                                <div class="product_sort_info font-xs mb-30" style="direction: rtl; text-align: right;">
                                    <ul>
                                        <li class="mb-10"><i class="fi-rs-refresh mr-5"></i> سياسة الإرجاع لمدة 30 يومًا
                                        </li>
                                        <li><i class="fi-rs-credit-card mr-5"></i> الدفع عند الاستلام متاح</li>
                                    </ul>
                                </div>
                                ...
                                <br>
                                <label for="quantity" style="display: inline-block; margin-right: 10px;">الكمية
                                    :</label>
                                <input type="number" name="quantity" id="quantity" value="1" min="1"
                                       style="display: inline-block; width: 50px; padding: 6px; text-align: center; border: 1px solid #ccc; border-radius: 3px;">
                                <div class="bt-1 border-color-1 mt-30 mb-30"></div>
                                <div class="detail-extralink">
                                    <div class="product-extra-link2">
                                        <button type="submit" class="button button-add-to-cart">أضف إلي السلة</button>
                                        <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                           href="{{route('fav.store',$product)}}"><i class="fi-rs-heart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Detail Info -->
                                        ...
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                    ...
                                                    <a href="{{route('products.show', $relatedProduct->id)}}"
                                                       tabindex="0">
                                                        @foreach($relatedProduct->getMedia('productFiles') as $media)
                                                            <img class="default-img" src="{{ $media->getFullUrl() }}"
                                                ...
                                                <div class="product-action-1">
                                                    ...
                                                    <a aria-label="أضف إالي المفضلة" class="action-btn small hover-up"
                                ...
                                <div class="custome-checkbox">
                                    @foreach (explode(',', $product->color) as $color)
                                        <input class="form-check-input" type="checkbox" name="color"
                                               id="exampleCheckbox{{ $loop->iteration }}" value="{{ $color }}">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    @foreach($newProduct->getMedia('productFiles') as $media)
                                        <a href="{{route('products.show', $newProduct->id)}}"><img
                                                src="{{$media->getFullUrl()}}" alt="product image"></a>
                                        @break
                                    @endforeach
                                </div>
