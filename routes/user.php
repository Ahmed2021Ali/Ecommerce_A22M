...
Route::get('/category/products/{category_id}', [ProductController::class, 'productsOfCategory'])->name('category.show.products');
...
Route::post('/store/{product}', [FavController::class, 'store'])->name('store');
